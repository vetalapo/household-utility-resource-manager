...
namespace HurManager.App.Common.Monads
{
    public static class Maybe
    {
        ...
        /// <returns>object that was acted on</returns>
        public static IEnumerable<TInput> Do<TInput>(this IEnumerable<TInput> o, Action<TInput> action)
            where TInput : class
        {
            if (o == null)
            {
